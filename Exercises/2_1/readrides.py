...
if __name__ == '__main__':
    ...
    rides = read_rides(r'C:\Users\HARSHAD BHUSARE\Desktop\SKILL UP\python-mastery\Data\ctabus.csv')

    print('Memory Use: Current %d, Peak %d' % tracemalloc.get_traced_memory())
    
    
#Class with __slots__ use lowest memory second runner up is tuple and worst is namedtuple